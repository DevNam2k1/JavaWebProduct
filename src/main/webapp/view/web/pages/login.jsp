<%-- 
    Document   : login
    Created on : Nov 5, 2021, 10:07:11 PM
    Author     : laptop88
--%>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
					...
					<div class="wrap-input100 validate-input" data-validate = "Nhập email đúng định dạng: ex@abc.xyz">
					...
					<div >
						<a href="<%=request.getContextPath()%>/reigster-form" class=" flex-c-m ">
